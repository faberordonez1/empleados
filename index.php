...
<body>
    <div class="container my-5">
        ...
        <form action="create.php" method="POST">
          <div class="row mb-3">
            <label for="name" class="col-sm-2 col-form-label fw-bold">Nombre completo*</label>
            <div class="col-sm-10">
           ...
           <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="desarrollador">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="auxiliarAdministrativo" >
